                        ...
                        <form className="popup-form">
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-3">
                                    ...
                                    <input type="text" className="form-control"  name="comapanySize" defaultValue={this.state.companySize} placeholder={this.state.companySize} onChange = {this.onChange}/>
                                </div>
